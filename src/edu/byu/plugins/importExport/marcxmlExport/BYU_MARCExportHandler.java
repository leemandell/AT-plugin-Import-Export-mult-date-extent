...
package
		...
		edu.byu.plugins.importExport.marcxmlExport;
...
public class BYU_MARCExportHandler implements Runnable {
	...
	public BYU_MARCExportHandler(ExportOptionsMARC exportOptions) {
		super();
	...
	public boolean export(InfiniteProgressPanel progressPanel,
		...
		BYU_MARCExport marc = new BYU_MARCExport();
