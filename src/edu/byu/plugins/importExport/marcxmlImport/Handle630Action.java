...
public class Handle630Action implements MARCXMLAction
{
    ...
    String thesaurus;
    String subjects[] = {"3","a","d","e","f","g","h","k","l","m","n","o","p","r","s","t","v","x","y","z","4"};
    ...
    try{
        BYU_MARCIngest.addSubjects(resource,subjectS,"Uniform Title (630)",thesaurus);
    }
