...
public class Handle611Action implements MARCXMLAction
{
    public void processElement(Resources resource, Object o, InfiniteProgressPanel progressPanel){
        ...
        Vector<String> subUnits = BYU_MARCIngest.getSubCodeValues(dataField,"e");
        int count=0;
        ...
        */
        ...
        String role = BYU_MARCIngest.getSubCodeValue(dataField,"4");
        
        try{
            BYU_MARCIngest.addName(resource,name,function,role,formField);
        }
