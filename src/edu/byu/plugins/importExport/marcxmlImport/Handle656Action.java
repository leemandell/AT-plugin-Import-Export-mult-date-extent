...
public class Handle656Action implements MARCXMLAction
{
    ...
    try{
        BYU_MARCIngest.addSubjects(resource,subjectS,"Occupation (656)",thesaurus);
    }
