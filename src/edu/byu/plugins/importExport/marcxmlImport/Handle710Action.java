...
public class Handle710Action implements MARCXMLAction
{
    public void processElement(Resources resource, Object o, InfiniteProgressPanel progressPanel){
        ...
        //String type = BYU_MARCIngest.addItemToList(Names.class,"nameType",name.CORPORATE_BODY_TYPE);
        name.setNameType(type);
        
        name.setCorporatePrimaryName(BYU_MARCIngest.getSubCodeValue(dataField,"a"));
        //name.setSortName(BYU_MARCIngest.getSubCodeValue(dataField,"a"));
        
        /*
        Vector<String> subUnits = BYU_MARCIngest.getSubCodeValues(dataField,"b");
        int count=0;
        ...
        */
        ...
        name.setNumber(BYU_MARCIngest.getSubCodeValue(dataField,"n"));
        ...
        setQualifier(name,"Form subdivision","v",dataField);//DIFF between 610
