...
public class Handle650Action implements MARCXMLAction
{
    ...
    String thesaurus;
    String subjects[] = {"3","a","d","e","v","x","y","z","4"};
    ...
    try{
        BYU_MARCIngest.addSubjects(resource,subjectS,"Topical Term (650)",thesaurus);
    }
