...
public class Handle355Action implements MARCXMLAction
{
    public void processElement(Resources resource, Object o, InfiniteProgressPanel progressPanel) throws UnsupportedRepeatingDataTypeException {
		...
		String titles[] = {"a","b","c","d","e","f","g","h","j"};
		...
		ArchDescriptionNotes adn = new ArchDescriptionNotes(resource,"Security Classification Control",NotesEtcTypes.DATA_TYPE_NOTE,resource.getRepeatingData().size()+1,noteType,title);
