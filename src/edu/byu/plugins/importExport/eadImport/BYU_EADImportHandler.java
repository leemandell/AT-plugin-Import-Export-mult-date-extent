...
public class BYU_EADImportHandler extends ImportHandler {
	 ...
	 * Constructor.
	 */
	public BYU_EADImportHandler(ImportOptionsEAD importOptions) {
		super();
	...
	public boolean importFileNew(File file, InfiniteProgressPanel progressPanel) throws JAXBException,
		...
		ead = (Ead) BYU_EADInfo.getContext().createUnmarshaller().unmarshal(
	...
	public void saveResource(Resources resource, int method, InfiniteProgressPanel progressPanel)
		...
		if (method == UPDATE) {
			...
			ResourceUtils.rewriteTargets(resource, BYU_EADImport.idPairs, progressPanel);
			if (debug) {
	...
	private static void setResourcesDAO(ResourcesDAO resourcesDAO) {
		BYU_EADImportHandler.resourcesDAO = resourcesDAO;
	}
	...
	public static void setTruncations(String truncations) {
		BYU_EADImportHandler.truncations = truncations;
	}

	public static void addToTruncations(String text) {
		BYU_EADImportHandler.truncations = BYU_EADImportHandler.truncations+text;
	}
