...
public class BYU_HandleBibliographyAction implements Action
{
...
//            ApplicationFrame.getInstance().updateProgressMessageSecondLine("Importing Bibliography element");
            ...
            appBibElement.setPersistentId(BYU_EADInfo.getReferenceTOResources().getNextPersistentIdAndIncrement());
            BYU_EADInfo.addIdPairs(id,appBibElement.getPersistentId());
