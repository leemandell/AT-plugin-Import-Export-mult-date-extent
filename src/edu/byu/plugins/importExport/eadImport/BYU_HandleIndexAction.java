...
public class BYU_HandleIndexAction implements Action
{
...
//        ApplicationFrame.getInstance().updateProgressMessageSecondLine("Importing index element");
        ...
        handled.add(org.archiviststoolkit.structure.EAD.Bibref.class);
            ...
            while(it3.hasNext()){
                ...
                index.setPersistentId(BYU_EADInfo.getReferenceTOResources().getNextPersistentIdAndIncrement());
                BYU_EADInfo.addIdPairs(eadIndex.getId(),index.getPersistentId());
