...
public class BYU_HandlePhyslocAction implements Action {
...
//        ApplicationFrame.getInstance().updateProgressMessageSecondLine("Importing physloc element");
        ...
        adn.setSequenceNumber(BYU_EADInfo.sequence++);
        adn.setPersistentId(BYU_EADInfo.getReferenceTOResources().getNextPersistentIdAndIncrement());
        BYU_EADInfo.addIdPairs(((Physloc)o).getId(), adn.getPersistentId());
