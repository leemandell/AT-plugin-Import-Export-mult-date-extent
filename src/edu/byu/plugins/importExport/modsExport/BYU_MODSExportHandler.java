...
public class BYU_MODSExportHandler implements Runnable {
    private File file = null;
    private ExportOptionsMARC exportOptions;
    private DigitalObjects digitalObject;

    public BYU_MODSExportHandler(ExportOptionsMARC exportOptions) {
        super();
    ...
    public void run() {
        BYU_MODSExport mods = new BYU_MODSExport();
    }
